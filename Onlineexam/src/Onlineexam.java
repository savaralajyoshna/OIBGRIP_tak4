...
{  
    ...
    {  
        ...
        if(current==6)  
        {  
            l.setText("Que7: The \u0021 article referred to as a? ");  
            jb[0].setText("unicode escape sequence");jb[1].setText("octal escape");jb[2].setText("Hexa decimal");  
                        jb[3].setText("Line field");  
        }  
        if(current==7)  
        {  
            l.setText("Que8: ____ is used to fix and find bugs in the java programs");  
            jb[0].setText("JVM");jb[1].setText("JRE");jb[2].setText("JDK");  
                        jb[3].setText("JDB");         
        }  
        if(current==8)  
        {  
            l.setText("Que9: What is the return type of the hashcode() method in object class");  
        ...
        {  
            ...
            jb[0].setText("64,32");jb[1].setText("32,32");jb[2].setText("32,64");  
                        jb[3].setText("64,64");  
        }  
